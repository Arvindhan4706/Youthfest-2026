...
const STATIC_EVENTS = [
  ...
  { id: 'pre-2', track_id: 'pre-events', title: 'Charity Match', description: 'Lace up your boots! A high-stakes football match where every single goal supports an amazing cause.', team_size: '11', fee: '₹500', difficulty: 'Medium', image_url: '/event-images/football.png', event_date: 'August 12 - 04:00 PM', venue: 'Football Ground', rules: ["All participants must carry their valid college ID cards."] },
  { id: 'pre-3', track_id: 'pre-events', title: 'Chess', description: 'Checkmate. No luck involved, just pure strategy. Can you outsmart the best minds on campus?', team_size: '1', fee: '₹100', difficulty: 'Hard', image_url: '/event-images/chess.png', event_date: 'August 12 - 09:00 AM', venue: 'Indoor Stadium', rules: ["All participants must carry their valid college ID cards."] },
  ...
  { id: 'pre-5', track_id: 'pre-events', title: 'Sudoku', description: 'Number crunching at its finest. Test your logic and speed in this brain-bending challenge.', team_size: '1', fee: '₹50', difficulty: 'Medium', image_url: '/event-images/sudoku.png', event_date: 'August 12 - 11:00 AM', venue: 'Seminar Hall 2', rules: ["All participants must carry their valid college ID cards."] },
  // Workshops
  { id: 'ws-1', track_id: 'workshops', title: 'Calistro', description: 'Always wanted to design like a pro? Dive into UI/UX aesthetics, digital arts, and creative design in this hands-on workshop.', team_size: '1', fee: '₹250', difficulty: 'Medium', image_url: '/event-images/calistro.png', event_date: 'August 12 - 10:00 AM', venue: 'Seminar Hall A', rules: ["All participants must carry their valid college ID cards."] },
