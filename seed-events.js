...
const STATIC_EVENTS = [
  ...
  { id: 'pre-2', track_id: 'pre-events', title: 'Charity Match', description: 'Lace up your boots! A high-stakes football match where every single goal supports an amazing cause.', team_size: '11', fee: '₹500', difficulty: 'Medium', image_url: '/event-images/football.png', event_date: 'August 21 - 04:00 PM', venue: 'Football Ground', rules: ["All participants must carry their valid college ID cards."] },
  { id: 'pre-3', track_id: 'pre-events', title: 'Chess', description: 'Checkmate. No luck involved, just pure strategy. Can you outsmart the best minds on campus?', team_size: '1', fee: '₹100', difficulty: 'Hard', image_url: '/event-images/chess.png', event_date: 'August 21 - 09:00 AM', venue: 'Indoor Stadium', rules: ["All participants must carry their valid college ID cards."] },
  { id: 'pre-4', track_id: 'pre-events', title: 'Pickle Ball', description: 'The hype is real! Grab a paddle and hit the courts for some incredibly fast-paced, addictive Pickleball action.', team_size: '2', fee: '₹150', difficulty: 'Medium', image_url: '/event-images/pickle_ball.png', event_date: 'August 21 - 02:00 PM', venue: 'Tennis Court', rules: ["All participants must carry their valid college ID cards."] },
  { id: 'pre-5', track_id: 'pre-events', title: 'Sudoku', description: 'Number crunching at its finest. Test your logic and speed in this brain-bending challenge.', team_size: '1', fee: '₹50', difficulty: 'Medium', image_url: '/event-images/sudoku.png', event_date: 'August 21 - 11:00 AM', venue: 'Seminar Hall 2', rules: ["All participants must carry their valid college ID cards."] },
  // Workshops
  { id: 'ws-1', track_id: 'workshops', title: 'Calistro', description: 'Always wanted to design like a pro? Dive into UI/UX aesthetics, digital arts, and creative design in this hands-on workshop.', team_size: '1', fee: '₹250', difficulty: 'Medium', image_url: '/event-images/calistro.png', event_date: 'August 21 - 10:00 AM', venue: 'Seminar Hall A', rules: ["All participants must carry their valid college ID cards."] },
  { id: 'ws-2', track_id: 'workshops', title: 'AIDS', description: 'No boring theory here. Get your hands dirty building actual machine learning models in this AI & Data Science masterclass.', team_size: '1-2', fee: '₹300', difficulty: 'Hard', image_url: 'https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?auto=format&fit=crop&w=800&q=80', event_date: 'August 21 - 02:00 PM', venue: 'AI Super Lab', rules: ["All participants must carry their valid college ID cards."] },
  { id: 'ws-3', track_id: 'workshops', title: 'Resolution', description: 'Take your editing to the next level. Learn 3D visualization, high-res media processing, and pro digital content creation.', team_size: '1', fee: '₹200', difficulty: 'Medium', image_url: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&w=800&q=80', event_date: 'August 21 - 11:30 AM', venue: 'Media Studio', rules: ["All participants must carry their valid college ID cards."] },
  { id: 'ws-4', track_id: 'workshops', title: 'Asymmetric', description: 'Curious about hacking? Learn ethical hacking, cybersecurity basics, and cryptography in this intensive security workshop.', team_size: '1-2', fee: '₹300', difficulty: 'Hard', image_url: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=800&q=80', event_date: 'August 21 - 01:30 PM', venue: 'Cyber Security Lab', rules: ["All participants must carry their valid college ID cards."] },
  { id: 'ws-5', track_id: 'workshops', title: 'Celestius', description: 'Space nerds, this one is for you! Get hands-on with interactive astronomy, space tech, and satellite engineering.', team_size: '1', fee: '₹250', difficulty: 'Medium', image_url: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=800&q=80', event_date: 'August 21 - 03:30 PM', venue: 'Space Research Centre', rules: ["All participants must carry their valid college ID cards."] },
];
