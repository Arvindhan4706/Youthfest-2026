...
export default function ToastContainer() {
 ...
 return (
 <div className="fixed bottom-24 right-6 z-[9999] flex flex-col gap-3 max-w-sm w-full pointer-events-none">
 <AnimatePresence>
 {toasts.map((toast) => (
 <motion.div
 key={toast.id}
 ...
 className="pointer-events-auto bg-black/80 border border-white/10 rounded-xl p-4 shadow-2xl flex items-start gap-3 relative overflow-hidden group"
 >
