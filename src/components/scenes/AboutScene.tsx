      ...
      <div className="relative z-10 max-w-6xl mx-auto space-y-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="relative rounded-2xl border border-[var(--neon-cyan)]/20 bg-[var(--neon-cyan)]/[0.03] p-8 overflow-hidden"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6, delay: 0.1 }}
            className="relative rounded-2xl border border-[var(--neon-magenta)]/20 bg-[var(--neon-magenta)]/[0.03] p-8 overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-40 h-40 bg-[var(--neon-magenta)]/5 rounded-full blur-3xl" />
            <div className="flex items-center gap-3 mb-5 relative z-10">
              <div className="w-10 h-10 rounded-xl bg-[var(--neon-magenta)]/10 flex items-center justify-center text-[var(--neon-magenta)]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {whatWeDo.map((item, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  variants={fadeUp}
                  className="flex items-center gap-3 px-4 py-3 rounded-xl border border-white/10 bg-white/[0.02] hover:bg-white/[0.05] hover:border-[var(--neon-cyan)]/20 transition-all duration-300 group"
                >
        ...
        <motion.div
          ...
          className="text-center relative rounded-3xl border border-white/10 bg-white/[0.02] p-12 md:p-16 overflow-hidden"
        >
