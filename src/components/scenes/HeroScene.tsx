      ...
      <div className="relative z-20 max-w-5xl mx-auto text-center flex flex-col items-center mt-8 sm:mt-16 pointer-events-auto">
        ...
        >
          <div className="relative z-20">
            <Image src="/yuvenzalogo.png" alt="Youthfest Event Logo" width={300} height={112} priority style={{ height: "auto" }} className="w-[57px] sm:w-[72px] md:w-[90px] object-contain" />
          </div>
        </motion.div>
