...
function EventDetailDrawer({ event, trackColor, onClose }: { event: EventItem; trackColor: string; onClose: () => void }) {
 ...
 <div className="p-6 border-t border-white/10 bg-[#030014] shrink-0">
  ...
  // Pre Events
  { id: 'pre-2', track_id: 'pre-events', title: 'Football – Charity Match', desc: 'A football match for a good cause. 7-a-side with 3 substitutes. Max 16 teams.', team: '10', fee: '₹200', difficulty: 'Medium', image: '/event-images/football.png', date: '17th, 18th & 19th August 2026', venue: 'Football Ground', rules: footballRules },
  { id: 'pre-3', track_id: 'pre-events', title: 'Chess', desc: 'Intense rapid chess tournament (10 mins/game). Max 60 registrations.', team: '1', fee: 'Free', difficulty: 'Hard', image: '/event-images/chess.png', date: '13th August 2026', venue: 'Indoor Stadium', rules: chessRules },
