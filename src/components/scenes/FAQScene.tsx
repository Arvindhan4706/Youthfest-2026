...
const FAQ_DATA: FAQItem[] = [
  ...
  { question: 'What is the total prize pool?', answer: 'Over ₹2,00,000 in cash prizes across all events. Top prizes of ₹50,000 for flagship competitions, plus trophies, certificates, and sponsor goodies.', category: 'Events' },
