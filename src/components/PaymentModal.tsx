...
export default function PaymentModal() {
 ...
 return (
 <div ref={overlayRef} onClick={handleClose} className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 opacity-0 p-4">
 <div ref={modalRef} onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true" aria-labelledby="payment-modal-title" className="relative w-full max-w-md bg-black border border-[var(--theme-primary)]/30 rounded-3xl shadow-[0_0_50px_rgba(0,240,255,0.1)] opacity-0 max-h-[90dvh] flex flex-col overflow-y-auto data-[lenis-prevent=true]:true">
