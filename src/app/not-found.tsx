...
export default function NotFound() {
 ...
 <Link 
 href="/"
 className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[var(--neon-cyan)] text-[#000000] font-black uppercase tracking-wider rounded-xl hover:opacity-90 transition-all hover:scale-105 shadow-[0_0_20px_rgba(0,240,255,0.4)]"
 >
